...
//  URL_BASE: '//www.example.com/foo/', // absolute base path
   ...
   * @type String
   */
  DIR_THEME: '../web/assets',

  /**
   * Path to theme styleguide output files
   *
   * @property DIR_THEME_STYLEGUIDE
   * @type String
   */
  // DIR_THEME_STYLEGUIDE: '../styleguide',
   ...
   * accessible.
   *
   * SET TO TRUE TO CLEAN AND PLACE FILES IN ../web/assets
   *
